...
<head>
    ...
    <title>Login - {{ \App\Helpers\SettingsHelper::schoolName() }}</title>
            ...
            <div class="video-content">
                ...
                <div class="professional-fade-in">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-white tracking-tight">{{ $schoolName }}</h1>
                ...
                <div class="professional-fade-in" style="animation-delay: 0.4s;">
                    <p class="text-gray-400 text-sm font-light">&copy; {{ date('Y') }} {{ $schoolName }}. Hak cipta dilindungi.</p>
                </div>
            </div>
        </div>
                ...
                <div class="mobile-video lg:hidden mb-4 rounded-2xl overflow-hidden">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center z-10">
                        <div class="text-center">
                            ...
                            @endif
                            <h1 class="text-xl font-bold text-white tracking-tight">{{ $schoolName }}</h1>
                ...
                <div class="premium-card rounded-3xl p-6 professional-fade-in">
                    ...
                    <div class="mb-6 text-center">
                        <div class="flex items-center justify-center space-x-3 mb-3">
                            ...
                            @endif
                            <div class="text-left">
                                <h1 class="text-base font-bold text-slate-900">{{ $schoolName }}</h1>
                    ...
                    <form action="{{ route('login') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            @error('email')
                                <p class="text-red-500 text-xs mt-1 font-medium tracking-tight">{{ $message }}</p>
                            @enderror
                        </div>
