<div>
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Jadwal Pelajaran</h1>
        <p class="text-gray-600 dark:text-gray-400">Jadwal pelajaran Anda</p>
    </div>
                        ...
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                                    {{ $item->guru->nama_lengkap ?? 'Guru' }} • {{ $item->ruangan }}
                                </p>
                            </div>
        ...
        @else
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-8 text-center">
                ...
                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                    Tidak ada jadwal pelajaran untuk hari {{ $hariFilter }}.
                </p>
            </div>
        @endif
    </div>
