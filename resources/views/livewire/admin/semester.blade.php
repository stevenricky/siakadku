                ...
                <div class="p-4">
                    @forelse($semesters as $semester)
                        <div class="border-b border-gray-200 dark:border-gray-700 pb-4 mb-4 last:border-0 last:pb-0 last:mb-0">
                            ...
                            <div class="flex justify-between items-start mb-3">
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white">{{ $semester->nama_semester }}</h3>
                            ...
                            <div class="mb-3 text-sm">
                                <div class="flex justify-between mb-1">
                                    ...
                                    <span class="text-gray-900 dark:text-white">{{ $semester->tahunAjaran->tahun_ajaran }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-500 dark:text-gray-400">Periode:</span>
                                    <span class="text-gray-900 dark:text-white">{{ $semester->tanggal_mulai->format('d/m/Y') }} - {{ $semester->tanggal_selesai->format('d/m/Y') }}</span>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-2">
                                ...
                                <button wire:click="delete({{ $semester->id }})" 
                                        wire:confirm="Apakah Anda yakin ingin menghapus semester ini?"
                    ...
                    @empty
                        <div class="text-center py-8">
                            ...
                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Tidak ada data semester</p>
                        </div>
                    @endforelse
                </div>
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                                    {{ $semester->tahunAjaran->tahun_ajaran }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                ...
                <div>
                    ...
                    <form wire:submit.prevent="save">
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                <label for="nama_semester" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                    Semester
                                </label>
                                <select wire:model="nama_semester"
                                        id="nama_semester"
                                ...
                                @error('nama_semester') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                            </div>

                            <div>
                                <label for="tahun_ajaran_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                    Tahun Ajaran
                                </label>
                            ...
                            <div class="flex items-center">
                                <input wire:model="is_aktif" 
                                       id="is_aktif"
                                       type="checkbox" 
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded dark:bg-gray-700 dark:border-gray-600">
                                <label for="is_aktif" class="ml-2 block text-sm text-gray-900 dark:text-gray-300">
