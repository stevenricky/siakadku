                ...
                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                    ...
                    <div class="mb-3">
                        <div class="flex items-center mb-2">
                            <div class="h-8 w-8 flex-shrink-0 bg-blue-100 rounded-full flex items-center justify-center mr-3">
                    ...
                    <div class="grid grid-cols-2 gap-2 mb-3 text-xs">
                        <div>
                            <span class="font-medium text-gray-500 dark:text-gray-400">Pinjam:</span>
                            <div class="text-gray-900 dark:text-white">{{ \Carbon\Carbon::parse($item->tanggal_pinjam)->format('d M Y') }}</div>
                        </div>
                        <div>
                            <span class="font-medium text-gray-500 dark:text-gray-400">Kembali:</span>
                            <div class="text-gray-900 dark:text-white">{{ \Carbon\Carbon::parse($item->tanggal_kembali)->format('d M Y') }}</div>
                        </div>
                        @if($item->tanggal_dikembalikan)
                        <div class="col-span-2">
                            <span class="font-medium text-gray-500 dark:text-gray-400">Dikembalikan:</span>
                            <div class="text-gray-900 dark:text-white">{{ \Carbon\Carbon::parse($item->tanggal_dikembalikan)->format('d M Y') }}</div>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="flex justify-end space-x-2 pt-3 border-t border-gray-200 dark:border-gray-600">
                        <button 
                            ...
                            class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300 text-sm px-3 py-1 bg-blue-50 dark:bg-blue-900/20 rounded transition-colors"
                            title="Detail"
                        >
                        ...
                        @if(in_array($item->status, ['dipinjam', 'terlambat']))
                            <button 
                                ...
                                class="text-green-600 hover:text-green-900 dark:text-green-400 dark:hover:text-green-300 text-sm px-3 py-1 bg-green-50 dark:bg-green-900/20 rounded transition-colors"
                                title="Kembalikan"
                            >
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div class="p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Siswa Peminjam</p>
                        <p class="text-gray-900 dark:text-white">{{ $selectedPeminjaman->siswa->nama }}</p>
                        <p class="text-sm text-gray-500 dark:text-gray-400">{{ $selectedPeminjaman->siswa->kelas->nama_kelas ?? '-' }}</p>
                    </div>

                    <div>
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Buku yang Dipinjam</p>
                        <p class="text-gray-900 dark:text-white">{{ $selectedPeminjaman->buku->judul }}</p>
                        <p class="text-sm text-gray-500 dark:text-gray-400">{{ $selectedPeminjaman->buku->penulis }} - {{ $selectedPeminjaman->buku->penerbit }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 dark:text-white">{{ $selectedPeminjaman->petugas->name }}</p>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                            <div class="text-sm text-blue-800 dark:text-blue-300">
                                ...
                                <p class="mt-1">{{ $selectedPeminjaman->siswa->nama }} - {{ $selectedPeminjaman->buku->judul }}</p>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Kondisi Buku *</label>
                            <select 
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                rows="2" 
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white" 
                                placeholder="Keterangan kondisi buku..."
                            ></textarea>
                        </div>
                    </div>
