            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                ...
                <div class="space-y-2 mb-3">
                    <div class="flex justify-between">
                        <span class="text-xs text-gray-500 dark:text-gray-400">Kode</span>
                        <span class="text-xs font-mono font-medium text-gray-900 dark:text-white">{{ $item->kode_peminjaman }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-xs text-gray-500 dark:text-gray-400">Buku</span>
                        <span class="text-xs font-medium text-gray-900 dark:text-white">{{ Str::limit($item->buku->judul, 20) }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-xs text-gray-500 dark:text-gray-400">Pinjam</span>
                        <span class="text-xs font-medium text-gray-900 dark:text-white">{{ \Carbon\Carbon::parse($item->tanggal_pinjam)->translatedFormat('d M Y') }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-xs text-gray-500 dark:text-gray-400">Kembali</span>
                        <span class="text-xs font-medium text-gray-900 dark:text-white">{{ \Carbon\Carbon::parse($item->tanggal_kembali)->translatedFormat('d M Y') }}</span>
                    </div>
                    @if($item->denda > 0)
                    <div class="flex justify-between">
                        <span class="text-xs text-gray-500 dark:text-gray-400">Denda</span>
                        <span class="text-xs font-medium text-red-600 dark:text-red-400">Rp {{ number_format($item->denda, 0, ',', '.') }}</span>
                    </div>
                    @endif
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div class="p-4 sm:p-6">
                ...
                <form wire:submit="simpanPeminjaman">
                    ...
                    <div class="flex flex-col sm:flex-row sm:justify-end sm:space-x-3 mt-6 gap-3">
                        <button 
                            type="button" 
            ...
            <div class="p-4 sm:p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 dark:text-white">{{ $selectedPeminjaman->siswa->nama_lengkap }}</p>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-400 dark:text-gray-500">Kategori: {{ $selectedPeminjaman->buku->kategori->nama ?? '-' }}</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                            <div class="text-sm text-blue-800 dark:text-blue-300">
                                ...
                                <p class="mt-1">{{ $selectedPeminjaman->siswa->nama_lengkap }}</p>
                                <p class="text-xs mt-1">{{ $selectedPeminjaman->buku->judul }}</p>
