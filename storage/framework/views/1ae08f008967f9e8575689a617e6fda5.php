<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400"><?php echo e($subtitle); ?></p>
        </div>
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 sm:p-6 border-l-4 border-blue-500">
        ...
        <div class="flex items-center justify-between mb-3">
            ...
            <!--[if BLOCK]><![endif]--><?php if($realtimeStats['new_registrations'] > 0): ?>
            <div class="text-green-500 flex items-center text-sm">
                <svg class="w-3 h-3 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/>
                </svg>
                <span class="text-xs sm:text-sm ml-1">+<?php echo e($realtimeStats['new_registrations']); ?></span>
            </div>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        </div>
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <p class="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e($totalSiswa); ?></p>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1"><?php echo e($siswaAktif); ?> aktif</p>
            </div>
        </div>
    </div>
...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 sm:p-6 border-l-4 border-green-500">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <p class="text-xl font-semibold text-gray-900 dark:text-white">
                <?php echo e($realtimeStats['today_present']); ?>/<?php echo e($realtimeStats['today_attendance']); ?>
    ...
    <div class="mt-3 w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
        <div class="bg-green-500 h-2 rounded-full transition-all duration-500 ease-out" 
             style="width: <?php echo e(min($attendanceRate, 100)); ?>%"></div>
    </div>
</div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 sm:p-6 border-l-4 border-purple-500">
            <div class="flex items-center">
                ...
                <div class="ml-3 sm:ml-4">
                    ...
                    <p class="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e($realtimeStats['online_users']); ?></p>
                    <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($realtimeStats['active_sessions']); ?> sesi</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 sm:p-6 border-l-4 border-yellow-500">
            <div class="flex items-center">
                ...
                <div class="ml-3 sm:ml-4">
                    ...
                    <p class="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e($totalGuru); ?></p>
                    <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($guruAktif); ?> aktif</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <canvas id="attendanceTrendChart"
                        ...
                        x-data="{
                            init() {
                                ...
                                new Chart(ctx, {
                                    type: 'line',
                                    data: <?php echo \Illuminate\Support\Js::from($attendanceData)->toHtml() ?>,
                                    options: {
                                        responsive: true,
                                        maintainAspectRatio: false,
                                        plugins: {
                ...
                <canvas id="performanceChart"
                        ...
                        x-data="{
                            init() {
                                ...
                                new Chart(ctx, {
                                    type: 'doughnut',
                                    data: <?php echo \Illuminate\Support\Js::from($performanceData)->toHtml() ?>,
                                    options: {
                                        responsive: true,
                                        maintainAspectRatio: false,
                                        plugins: {
            ...
            <div class="h-48 sm:h-64">
                <canvas id="userActivityChart"
                        ...
                        x-data="{
                            init() {
                                const ctx = this.$el.getContext('2d');
                                const chartData = <?php echo \Illuminate\Support\Js::from($userActivityData)->toHtml() ?>;
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 sm:p-6">
            ...
            <div class="grid grid-cols-2 gap-3 sm:gap-4">
                <div class="text-center p-3 sm:p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    <div class="text-xl sm:text-2xl font-bold text-blue-600 dark:text-blue-400"><?php echo e($totalMapel); ?></div>
                ...
                <div class="text-center p-3 sm:p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                    <div class="text-xl sm:text-2xl font-bold text-green-600 dark:text-green-400"><?php echo e($siswaAktif); ?></div>
                ...
                <div class="text-center p-3 sm:p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                    <div class="text-xl sm:text-2xl font-bold text-purple-600 dark:text-purple-400"><?php echo e($mapelIpa); ?></div>
                ...
                <div class="text-center p-3 sm:p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                    <div class="text-xl sm:text-2xl font-bold text-yellow-600 dark:text-yellow-400"><?php echo e($mapelIps); ?></div>
            ...
            <div class="space-y-3">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center space-x-2">
                        <span class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($kelasX); ?></span>
                        <div class="w-16 sm:w-20 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                            <div class="bg-blue-500 h-2 rounded-full" 
                                 style="width: <?php echo e($totalSiswa > 0 ? ($kelasX / $totalSiswa) * 100 : 0); ?>%"></div>
                        </div>
                    </div>
                </div>
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center space-x-2">
                        <span class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($kelasXI); ?></span>
                        <div class="w-16 sm:w-20 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                            <div class="bg-green-500 h-2 rounded-full" 
                                 style="width: <?php echo e($totalSiswa > 0 ? ($kelasXI / $totalSiswa) * 100 : 0); ?>%"></div>
                        </div>
                    </div>
                </div>
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center space-x-2">
                        <span class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($kelasXII); ?></span>
                        <div class="w-16 sm:w-20 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                            <div class="bg-purple-500 h-2 rounded-full" 
                                 style="width: <?php echo e($totalSiswa > 0 ? ($kelasXII / $totalSiswa) * 100 : 0); ?>%"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 sm:p-6">
            ...
            <div class="space-y-3">
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-sm font-semibold text-green-600 dark:text-green-400"><?php echo e($realtimeStats['weekly_registrations']); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-sm text-gray-600 dark:text-gray-400">Sesi Aktif</span>
                    <span class="text-sm font-semibold text-blue-600 dark:text-blue-400"><?php echo e($realtimeStats['active_sessions']); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-sm text-gray-600 dark:text-gray-400">Backup Terakhir</span>
                    <span class="text-xs font-semibold text-gray-600 dark:text-gray-400"><?php echo e($lastBackup); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 sm:p-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-xs font-medium text-blue-600 dark:text-blue-400"><?php echo e($realtimeStats['data_source']); ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div class="px-4 sm:px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
            ...
            <div class="flex items-center space-x-2">
                <span class="text-xs text-gray-500 dark:text-gray-400">
                    Total: <?php echo e($totalSiswa); ?> siswa
                </span>
                <!--[if BLOCK]><![endif]--><?php if(Route::has('admin.siswa.index')): ?>
                    <a href="<?php echo e(route('admin.siswa.index')); ?>" class="text-primary-600 dark:text-primary-400 text-sm hover:underline">Lihat Semua</a>
                <?php else: ?>
        ...
        <div class="p-4 sm:p-6">
            <!--[if BLOCK]><![endif]--><?php if($recentSiswa->count() > 0): ?>
                <div class="space-y-3">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $recentSiswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $siswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="flex items-center">
                            <div class="h-8 w-8 sm:h-10 sm:w-10 bg-primary-100 dark:bg-primary-900 rounded-full flex items-center justify-center">
                                <span class="text-xs sm:text-sm font-medium text-primary-600 dark:text-primary-400">
                                    <?php echo e(strtoupper(substr($siswa->nama_lengkap ?? $siswa->nama, 0, 1))); ?>

                                </span>
                            </div>
                            <div class="ml-3">
                                <h4 class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($siswa->nama_lengkap ?? $siswa->nama); ?></h4>
                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                    <?php echo e($siswa->kelas->nama ?? 'Belum ada kelas'); ?> • <?php echo e($siswa->nis); ?>

                                </p>
                            </div>
                        </div>
                        <div class="text-right">
                            <span class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($siswa->created_at->format('d M Y')); ?></span>
                            <div class="text-xs text-green-500 dark:text-green-400 mt-1">
                                <?php echo e($siswa->created_at->diffForHumans()); ?>
...
setInterval(() => {
    window.Livewire.find('<?php echo e($_instance->getId()); ?>').refreshData();
}, 30000);
</script><?php /**PATH C:\Users\user\siakad-sma\resources\views/livewire/admin/admin-dashboard.blade.php ENDPATH**/ ?>