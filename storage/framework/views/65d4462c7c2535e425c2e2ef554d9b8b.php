...
<body class="h-full bg-gradient-super particles-container no-transition" 
    ...
    <?php if(auth()->check()): ?>
        <?php echo $__env->make('livewire.shared.sidebar', ['role' => auth()->user()->role], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?>
    ...
    <div class="min-h-screen flex flex-col main-content-transition"
        ...
        <?php if(auth()->check()): ?>
            <header class="header-container glass-header sticky top-0 transition-all duration-500"
                    x-data="headerApp()">
                <?php echo $__env->make('livewire.shared.header-simple', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </header>
        <?php endif; ?>
...
<footer class="glass-card mt-8 border-t border-gray-200 dark:border-gray-700 p-3 shrink-0">
    <div class="text-center">
        <p class="text-sm text-gray-600 dark:text-gray-400">
            &copy; <?php echo e(date('Y')); ?> <?php echo e(SettingsHelper::schoolName()); ?>. Hak Cipta Dilindungi.
        </p>
...
</html><?php /**PATH C:\Users\user\siakad-sma\resources\views/layouts/app-new.blade.php ENDPATH**/ ?>