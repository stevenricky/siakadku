            ...
            <div class="relative">
                <button @click="open = !open" class="flex items-center space-x-2 text-sm focus:outline-none transition-colors duration-200">
                    ...
                    <div class="text-left hidden lg:block">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 capitalize"><?php echo e($user->role); ?></p>
                    </div>
                </button>
                ...
                <div x-show="open" 
                    ...
                    <div class="p-4 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1"><?php echo e($user->email); ?></p>
                        <div class="mt-2">
                    ...
                    <div class="p-2 space-y-1">
                        ...
                        <?php if(auth()->user()->role === 'admin'): ?>
                            <?php if(Route::has('admin.pengaturan.index')): ?>
...
</script><?php /**PATH C:\Users\user\siakad-sma\resources\views/livewire/shared/header-simple.blade.php ENDPATH**/ ?>