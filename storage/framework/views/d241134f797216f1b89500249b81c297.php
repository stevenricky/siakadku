...
<div class="space-y-4 md:space-y-6">
    ...
    <div class="block md:hidden bg-white dark:bg-gray-800 p-4 rounded-lg shadow mb-4">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-gray-600 dark:text-gray-400"><?php echo e($this->subtitle); ?></p>
            </div>
    ...
    <div class="hidden md:flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400">
                Selamat belajar, <?php echo e($siswa->nama_lengkap ?? ($siswa->nama ?? 'Siswa')); ?> - <?php echo e($this->subtitle); ?>
    ...
    <div class="grid grid-cols-2 gap-3 md:hidden">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
            ...
            <p class="text-xl font-semibold text-gray-900 dark:text-white"><?php echo e(number_format($rataRataNilai, 1)); ?></p>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
            <p class="text-xs font-medium text-gray-600 dark:text-gray-400">Kehadiran</p>
            <p class="text-xl font-semibold text-gray-900 dark:text-white"><?php echo e($statistikKehadiran['hadir'] ?? 0); ?></p>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
            <p class="text-xs font-medium text-gray-600 dark:text-gray-400">Jadwal</p>
            <p class="text-xl font-semibold text-gray-900 dark:text-white"><?php echo e($jadwalHariIni->count()); ?></p>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
            <p class="text-xs font-medium text-gray-600 dark:text-gray-400">Pesan</p>
            <p class="text-xl font-semibold text-gray-900 dark:text-white"><?php echo e($unreadCount); ?></p>
        </div>
    </div>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white">
                        <?php echo e(number_format($rataRataNilai, 1)); ?>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 md:p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white">
                        <?php echo e($statistikKehadiran['hadir'] ?? 0); ?>

                    </p>
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                        dari <?php echo e($statistikKehadiran['total'] ?? 0); ?> hari
                    </p>
                </div>
    ...
    <div class="block md:hidden space-y-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
            <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e(now()->translatedFormat('l, d F Y')); ?></p>
            </div>
            <div class="p-4">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $jadwalHariIni; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jadwal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex items-center justify-between p-3 border border-gray-200 dark:border-gray-700 rounded-lg mb-2">
                    <div class="flex items-center">
                        <div class="w-8 h-8 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center">
                            <span class="text-blue-600 dark:text-blue-400 text-xs font-medium">
                                <?php echo e(substr(($jadwal->mapel->nama_mapel ?? $jadwal->mapel_id ?? 'M'), 0, 1)); ?>

                            </span>
                        </div>
                        <div class="ml-3">
                            <p class="text-sm font-medium text-gray-900 dark:text-white">
                                <?php echo e(\Illuminate\Support\Str::limit($jadwal->mapel->nama_mapel ?? ($jadwal->mapel_id ?? 'Mata Pelajaran'), 20)); ?>

                            </p>
                            <p class="text-xs text-gray-500 dark:text-gray-400">
                                <?php echo e(\Illuminate\Support\Str::limit($jadwal->guru->nama_lengkap ?? ($jadwal->guru_id ?? 'Guru'), 15)); ?>
                    ...
                    <div class="text-right">
                        <p class="text-sm font-medium text-gray-900 dark:text-white">
                            <?php echo e($jadwal->jam_mulai ?? '00:00'); ?>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
            <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">Bulan <?php echo e(now()->translatedFormat('F Y')); ?></p>
            </div>
            <div class="p-4">
                <div class="space-y-3">
                    <div class="flex justify-between items-center">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-sm font-medium text-gray-900 dark:text-white">
                            <?php echo e($statistikKehadiran['sakit'] ?? 0); ?>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-sm font-medium text-gray-900 dark:text-white">
                            <?php echo e($statistikKehadiran['izin'] ?? 0); ?>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-sm font-medium text-gray-900 dark:text-white">
                            <?php echo e($statistikKehadiran['alpha'] ?? 0); ?>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
            ...
            <div class="p-4">
                <!--[if BLOCK]><![endif]--><?php if($pesanTerbaru && $pesanTerbaru->count() > 0): ?>
                    <div class="space-y-3">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $pesanTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pesan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-start space-x-2 p-2 border border-gray-200 dark:border-gray-700 rounded-lg"
                                 wire:click="bukaChat(<?php echo e($pesan->pengirim_id); ?>)">
                                <div class="flex-shrink-0">
                                    <div class="w-8 h-8 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center">
                                        <span class="text-blue-600 dark:text-blue-400 text-xs font-medium">
                                            <?php echo e(substr($pesan->pengirim->name, 0, 1)); ?>
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-sm font-medium text-gray-900 dark:text-white truncate">
                                        <?php echo e($pesan->pengirim->name); ?>

                                    </p>
                                    <p class="text-xs text-gray-600 dark:text-gray-400 truncate">
                                        <?php echo e(\Illuminate\Support\Str::limit($pesan->pesan, 30)); ?>

                                    </p>
                                </div>
                                <!--[if BLOCK]><![endif]--><?php if(!$pesan->dibaca): ?>
                                    <div class="flex-shrink-0">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between p-3 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <p class="text-sm font-medium text-gray-900 dark:text-white">
                                    <?php echo e($jadwal->mapel->nama_mapel ?? ($jadwal->mapel_id ?? 'Mata Pelajaran')); ?>

                                </p>
                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                    <?php echo e($jadwal->guru->nama_lengkap ?? ($jadwal->guru_id ?? 'Guru')); ?> • <?php echo e($jadwal->ruangan ?? 'Ruangan'); ?>
                        ...
                        <div class="text-right">
                            <p class="text-sm font-medium text-gray-900 dark:text-white">
                                <?php echo e($jadwal->jam_mulai ?? '00:00'); ?> - <?php echo e($jadwal->jam_selesai ?? '00:00'); ?>
        ...
        <div class="space-y-4 md:space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
                <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">Bulan <?php echo e(now()->translatedFormat('F Y')); ?></p>
                </div>
                <div class="p-6">
                    <div class="space-y-4">
                        <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-start space-x-3 p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-500 mt-1">
                                            <?php echo e($pesan->created_at->diffForHumans()); ?>
        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 md:p-4">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full h-full md:max-w-4xl md:h-[600px] flex flex-col md:flex-row">
                ...
                <div class="hidden md:block w-full md:w-1/3 border-r border-gray-200 dark:border-gray-700 flex flex-col">
                    ...
                    <div class="flex-1 overflow-y-auto">
                        ...
                        <div class="p-3">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $guruList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guru): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer transition-colors"
                                     wire:click="bukaChat(<?php echo e($guru['id']); ?>)">
                                    <div class="relative">
                                        <div class="w-8 h-8 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center">
                                            <span class="text-blue-600 dark:text-blue-400 text-xs font-medium">
                                                <?php echo e(substr($guru['nama'], 0, 1)); ?>

                                            </span>
                                        </div>
                                        <!--[if BLOCK]><![endif]--><?php if($guru['online']): ?>
                                    ...
                                    <?php
                                        $unreadFromGuru = \App\Models\Pesan::unread()
                                            ...
                                            ->count();
                                    ?>
                                    <!--[if BLOCK]><![endif]--><?php if($unreadFromGuru > 0): ?>
                                        <span class="bg-red-500 text-white text-xs rounded-full h-4 w-4 flex items-center justify-center text-[10px]">
                                            <?php echo e($unreadFromGuru); ?>
                ...
                <div class="flex-1 flex flex-col">
                    <!--[if BLOCK]><![endif]--><?php if($chatWith): ?>
                        <!-- Header Chat -->
                            ...
                            <div class="flex items-center space-x-2 md:space-x-3">
                                ...
                                <div class="w-8 h-8 md:w-10 md:h-10 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center">
                                    <span class="text-blue-600 dark:text-blue-400 text-sm md:text-base font-medium">
                                        <?php echo e(substr($chatWith->name, 0, 1)); ?>

                                    </span>
                                </div>
                                <div>
                                    <p class="font-semibold text-gray-900 dark:text-white text-sm md:text-base"><?php echo e($chatWith->name); ?></p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400">
                                        <!--[if BLOCK]><![endif]--><?php if($chatWith->isOnline()): ?>
                        ...
                        <div class="flex-1 overflow-y-auto p-3 md:p-4 space-y-3 md:space-y-4" id="chat-messages">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $percakapan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pesan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex <?php echo e($pesan->pengirim_id == auth()->id() ? 'justify-end' : 'justify-start'); ?>">
                                    <div class="max-w-[85%] md:max-w-xs lg:max-w-md px-3 py-2 md:px-4 md:py-2 rounded-lg <?php echo e($pesan->pengirim_id == auth()->id() ? 'bg-blue-600 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-white'); ?>">
                                        <p class="text-sm break-words"><?php echo e($pesan->pesan); ?></p>
                                        <div class="flex justify-between items-center mt-1">
                                            <p class="text-xs <?php echo e($pesan->pengirim_id == auth()->id() ? 'text-blue-200' : 'text-gray-500'); ?>">
                                                <?php echo e($pesan->created_at->format('H:i')); ?>

                                            </p>
                                            <!--[if BLOCK]><![endif]--><?php if($pesan->pengirim_id == auth()->id()): ?>
                                                <!--[if BLOCK]><![endif]--><?php if($pesan->dibaca): ?>
                                                    <span class="text-xs text-blue-200" title="Dibaca <?php echo e($pesan->dibaca_pada?->format('H:i')); ?>">
                                                        ✓✓
                                                    </span>
                                                <?php else: ?>
...
<script>
    document.addEventListener('livewire:init', () => {
        ...
        window.addEventListener('popstate', function(event) {
            if (document.querySelector('[wire\\:model="showChat"]') && window.Livewire.find('<?php echo e($_instance->getId()); ?>').showChat) {
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').tutupChat();
...
</script><?php /**PATH C:\Users\user\siakad-sma\resources\views/livewire/siswa/siswa-dashboard.blade.php ENDPATH**/ ?>